...
public class TestBase {
    ...
    static {
        ...
        if (Objects.equals(withMySQL, "yes") || Objects.equals(withAllContainers, "yes")) {
            ...
            var urlTemplate = "r2dbc:mysql://%s:%s/order_system?createDatabaseIfNotExist=true&characterEncoding=UTF-8&serverZoneId=UTC&allowPublicKeyRetrieval=true&useSSL=false";
